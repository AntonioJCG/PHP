...
<body>
    ...
    <table class="paginas">
        <tr>
            <td class="boton"><a href='ejercicio2.php?pagina=1'>Inicio</a></td>
            <?php
            if ($total_paginas > 1) {
                for ($i = 1; $i <= $total_paginas; $i++) {
                    ...
                    if ($pagina == $i) {
                        ...
                        echo "<a href='ejercicio2.php?pagina=$i'>$i</a>";
                    }
                    echo ("</td>");
                }
            }
            ?>
            <td class="boton"><a href='ejercicio2.php?pagina=<?= $total_paginas ?>'>Final</a></td>
            <?php
